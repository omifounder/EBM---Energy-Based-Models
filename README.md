...
┌───────────────────────────────────────────┐
│ STAGE 1: ROBUST ASR │
│ (Residual Energy-Based Model) │
│ │
│ Audio → Conformer-RNNT + Energy Model │
│ Output: Transcript + Confidence │
│ │
│ Innovation: Global scoring for │
...
│ │ │ │
│ wav2vec 2.0 + │ │ BERT + │
│ Prosody Features │ │ Sentiment │
│ │ │ Analysis │
│ Output: │ │ Output: │
│ Voice Embedding │ │ Text Embedding │
└─────────────────────┘ └─────────────────────┘
│ │
└───────────┬───────────────────┘
│
...
│ - Energy scoring │
│ │
│ Innovation: Detect "I'm fine" but │
│ distressed voice (depression biomarker) │
└───────────────────────────────────────────┘
│
▼
┌───────────────────────────────────────────┐
│ CONTEXT MANAGER │
│ │
│ Maintain conversation history (3-5 turns)│
│ Track: emotions, topics, inconsistencies │
└───────────────────────────────────────────┘
│
▼
┌───────────────────────────────────────────┐
...
│ │
│ Selection Logic: │
│ - High inconsistency → Probe │
│ - Negative emotion → Acknowledge │
│ - Crisis keywords → Resource offer │
...
│ States │ │ States │ │ Vectors │
│ │ │ │ │ │
│ h_enc │ │ h_dec │ │ c_attn │
│ [T_e×d_e] │ │ [T_d×d_d] │ │ [T_d×d_e] │
└───────────┘ └────────────┘ └─────────────────┘
│ │ │
│ │ │
│ │ ┌────────▼────────┐
